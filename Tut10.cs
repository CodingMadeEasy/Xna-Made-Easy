// C# XNA MADE EASY TUTORIAL 10 - CUSTOM MOUSE CURSOR
...
namespace WindowsGame1
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        string displayText = "www.codingmadeeasy.ca";
        bool display = false;
        ...
        protected override void LoadContent()
        {
            ...
            cursor = Content.Load<Texture2D>("cursorImage");
        }
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (mouse.X < buttonPosition.X || mouse.Y < buttonPosition.Y ||
                mouse.X > buttonPosition.X + font.MeasureString(buttonText).X ||
                mouse.Y > buttonPosition.Y + font.MeasureString(buttonText).Y)
            {
                buttonColor = new Color(0, 0, 0);
            }
            else
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            if (display)
                spriteBatch.DrawString(font, displayText, new Vector2(300, 300), Color.Orange);
